...
// Main Hero Component - Lightweight CSS-only version
const GalaxyHero = () => {
  return (
    <section id="home" className="galaxy-hero">
      ...
      <div className="galaxy-hero-content">
        ...
        >
          ...
          >
            Welcome to <span className="universe-text"> my space</span>
          </motion.h1>
          ...
          >
            Crafting high-performance C++ graphics engines and GPU-driven
            experiences close to the hardware
          </motion.p>
          ...
          >
            Graphics Developer <span className="role-separator">•</span>{" "}
            Software Systems
          </motion.p>
